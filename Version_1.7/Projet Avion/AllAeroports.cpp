...
void DifferentsAeroports::Dijkstra (int depart,int arrive,DifferentsAeroports Aeroports, int type, AllAvions Allavions)
{
    ...
    do
    {
        ...
        do
        {
            ...
            {
                if(decouverte[i] == 1 && poid_final[i] < poid_actuel && vol->cl_consomation(sommet_actuel->get_Distance()) >0)
                {
            ...
            for(auto s : sommet_actuel->getSuccesseurs())
            {
                ...
                if(decouverte[s->getNum()] == 0 && vol->cl_consomation(sommet_actuel->get_Distance()) >0)
                {
                ...
                if(decouverte[s->getNum()] == 1 && vol->cl_consomation(sommet_actuel->get_Distance()) >0)
                {
