...
DifferentsAeroports::DifferentsAeroports(std::string Fichier)
{
    ...
    string Nomaero, AttenteSol, AccesPiste, TempsDecol, DelaiAnticol,DureeVol;
    int local_x, local_y, NbPistes, NbPlaces, DistanceVol;
    for(int i=0; i<Nombres_Aeroports; i++)
    {
        ...
        m_vect_aero.push_back(new InfosAeroport(i,Nomaero,Localisation, NbPistes, NbPlaces, AttenteSol, AccesPiste, DelaiAnticol, TempsDecol, DureeVol, DistanceVol));
...
void DifferentsAeroports::Dijkstra (int depart,int arrive,DifferentsAeroports Aeroports)
{
    ...
    do
    {
        vector<InfosAeroport*> m_vect_aero=Aeroports.get_vecteur_aero();
...
void DifferentsAeroports::display_chemin(std::vector<int>predecesseur,int arrive, int depart, vector<InfosAeroport*> m_vect_aero, std::vector<int>poid_final)
{
