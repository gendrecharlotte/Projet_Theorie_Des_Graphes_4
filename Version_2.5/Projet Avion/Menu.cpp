...
void Menu::affichage_menu(AllAvions Avions,DifferentsAeroports Aeroports,Interface I, AllVoyageurs Voyageurs)
{
    ...
    do
    {
        ...
        else if(selec==3)
        {
            ...
            //Voyageurs.CreerVoyageurs(Aeroports, Avions);
            ...
            diff.Dijkstra(depart,arrivee,Aeroports, type_dep, Avions);
        ...
        else if(selec==5)
        {
            ...
            BITMAP* img;
            Coordonnees coo;
            std::stack<InfosAeroport*> sta;
            Avion a(5583,3,25,255,0,0,0,4,img,coo,0,sta);
            I.test(Avions, Aeroports, simulation);

             for(auto a:simulation.get_avions_en_vol())
            {
