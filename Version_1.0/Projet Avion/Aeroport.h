...
class InfosAeroport
{
    ...
    InfosAeroport();
    InfosAeroport(int Num,string Nom, string Localisation, int Nombre_Pistes, int Nombres_Places_Sol,  string Attente_Sol,
    ...
    void set_Localisation(string L);
