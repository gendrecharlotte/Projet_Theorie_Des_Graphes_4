...
InfosAeroport :: InfosAeroport(int Num, string Nom, string Localisation, int Nombres_Pistes, int Nombres_Places_Sol,  string Attente_Sol,
...
string InfosAeroport::get_Localisation()
{
