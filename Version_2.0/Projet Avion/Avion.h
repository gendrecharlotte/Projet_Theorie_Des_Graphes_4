...
public:
    ...
    Avion();
    Avion(int vitesse,int matricule,int type, int consomation, int capacite,int tmp_sol,int tmp_acces,int tmp_atterir,BITMAP *img,Coordonnees coo, bool da,std::stack<InfosAeroport*> trajet);
    ~Avion();
    ///GETTERS/SETTERS
