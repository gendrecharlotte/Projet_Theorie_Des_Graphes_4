...
public:
    ...
    Avion();
    Avion(int matricule,int type, int consomation, int capacite,int tmp_sol,int tmp_acces,int tmp_atterir,int etat,int vitesse, BITMAP *img,Coordonnees coo, bool da,std::stack<InfosAeroport*> trajet);
    ~Avion();
    ///GETTERS/SETTERS
